<script>
  ...
  // lokale Filter-States basierend auf den vom Server gelieferten Werten
  let filters = $state({
    search: data.filters.search,
    menueart: data.filters.menueart,
    aufwand: data.filters.aufwand,
    zeitaufwand: data.filters.zeitaufwand,
    sort: data.filters.sort ?? 'name_asc'
  });
</script>
...
<section class="section-block">
  ...
  <form class="filters" method="GET">
    ...
    <div class="field">
      <span>Menüart</span>
      <select name="menueart" bind:value={filters.menueart}>
    ...
    <div class="field">
      <span>Aufwand</span>
      <select name="aufwand" bind:value={filters.aufwand}>
        <option value=''>Alle</option>
    ...
    <div class="field">
      ...
      <select name="zeitaufwand" bind:value={filters.zeitaufwand}>
        <option value=''>Alle</option>
    ...
    <div class="field">
      ...
      <select name="sort" bind:value={filters.sort}>
